...
export default {
          ...
          docRef.put(this.file).on(
            ...
            async () => {
              ...
              await dataBase.set({
                ...
                blogSubtitile: this.blogSubtitile,
  ...
  computed: {
    ...
    blogSubtitile: {
      get() {
        return this.$store.getters.getPost.blogSubtitile
      },
      set(payload) {
        this.$store.dispatch('setPost', { blogSubtitile: payload })
      },
    },
  },
}
